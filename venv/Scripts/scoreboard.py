...
class Scoreboard():
    '''A class to report scoring informaion.'''

    def __init__(self, ai_settings, screen, stats):
        '''Initialize scorekeeping attriubutes.'''
        self.screen = screen
    ...
    def prep_score(self):
        ...
        # Display the score the score at the top right of the screen.
    ...
    def prep_high_score(self):
        ...
        # Center the hgih score at the top of the screen.
